        ...
        <div class="container py-5 text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="mb-4">You are currently not loged in or your recent session has expired, <a href="{{ route('login') }}">Login</a></h1>
                    <p class="mb-4">We're sorry, your request could not be processed</p>
