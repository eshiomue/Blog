            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>123 Street, Lagos, Nigeria</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+0234 906 481 7668</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>eshiomueafemikhe@gmail.com</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <h5 class="text-white mb-4">Social Media Links</h5>
                        <a class="btn btn-link text-white-50" href="">Facebook</a>
                        <a class="btn btn-link text-white-50" href="">Instagram</a>
